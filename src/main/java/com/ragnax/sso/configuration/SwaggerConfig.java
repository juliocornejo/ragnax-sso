...
public class SwaggerConfig {
	...
	private static final String PACKAGE_CONTROLLER = "com.ragnax.sso.controller";
	...
	private ApiInfo apiInfo() {
        ...
        return new ApiInfo("Microservices Rest seguridad", "MicroServicio que implementa " +
                "Seguridad y Autenticacion con spring boot.",
